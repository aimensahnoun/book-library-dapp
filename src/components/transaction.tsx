...
const Transaction = ({ hash }: { hash: string }) => {
    return <div className="flex w-full p-4 gap-x-4 hover:bg-modalBg">
        ...
        <div className="flex flex-col gap-y-2">
            ...
            <a className="text-blue-500" href={`${POLYSCAN_URL}/${hash}`} target="_blank" rel="noreferrer">View Transaction</a>
        </div>
